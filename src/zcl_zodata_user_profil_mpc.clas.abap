class ZCL_ZODATA_USER_PROFIL_MPC definition
  public
...
public section.
  ...
  types:
     TS_USERPROFILE type ZUSER_PROFILE .
  types:
TT_USERPROFILE type standard table of TS_USERPROFILE .
  types:
  ...
  constants GC_USERPROFILE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'UserProfile' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZODATA_USER_PROFIL_MPC====CP' ##NO_TEXT.

  methods DEFINE_USERPROFILE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZODATA_USER_PROFIL_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZODATA_USER_PROFILE_SRV' ).

define_userprofile( ).
  endmethod.


  method DEFINE_USERPROFILE.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'UserProfile' iv_def_entity_set = abap_false ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'user_id' iv_abap_fieldname = 'USER_ID' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZUSER_PROFILE'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'UserProfileSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250516083218'.                  "#EC NOTEXT
...
ls_text_element-artifact_name          = 'user_id'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'UserProfile'.                            "#EC NOTEXT
